...
public class User {
	 ...
	 *
	 * @param userID
	 *            the primary key of the row containing this user's info
	 * @param username
	 ...
	 *
	 * @param other
	 *            the User to compare against this one
	 * @return true if the user objects contain the same info, false if
	 *         otherwise
	 */
	public boolean equals(User other) {
		...
		return (this.userID == other.userID
				...
				&& this.displayName.equals(other.displayName) && this.cookieID
					.equals(other.cookieID));
	}// equals
